...
function Player:drawBody()
  ...
  love.graphics.setColor(r * 0.15, g * 0.15, b * 0.15, 0.5)
  love.graphics.polygon('fill', -Player.WIDTH * 1.2, Player.HEIGHT * 0.3,
    0, -Player.HEIGHT * 1.3,
    Player.WIDTH * 1.2, Player.HEIGHT * 0.3,
    0, Player.HEIGHT * 0.5)

  love.graphics.setColor(r * 0.3, g * 0.5, b * 0.7, 0.4)
  love.graphics.setLineWidth(3)
  love.graphics.polygon('line', -Player.WIDTH * 0.9, Player.HEIGHT * 0.2,
    0, -Player.HEIGHT * 1.1,
    Player.WIDTH * 0.9, Player.HEIGHT * 0.2,
    0, Player.HEIGHT * 0.4)

  love.graphics.setColor(r * 0.2, g * 0.4, b * 0.6, 0.6)
  love.graphics.polygon('fill', -Player.WIDTH * 0.6, Player.HEIGHT * 0.15,
    0, -Player.HEIGHT * 0.9,
    Player.WIDTH * 0.6, Player.HEIGHT * 0.15,
    0, Player.HEIGHT * 0.3)
  ...
  love.graphics.circle('fill', 0, -Player.HEIGHT * 0.2, 2)
...
function Player:draw()
  ...
  local color = Color.CYAN:clone()
  color.a = 0.3
  for i = 1, #self.trail_positions do
    local alpha = (1 - i / #self.trail_positions) * 0.4
    ...
    local scale = 1 - (i / #self.trail_positions) * 0.3
...
function Dead:enteredState()
  ...
  if self.gameState.screenEffects then
      self.gameState.screenEffects:shake(20, 0.5)
      self.gameState.screenEffects:flash(1, 0.1, 0.1, 0.4, 0.3)
  end
end
